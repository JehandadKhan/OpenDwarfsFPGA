...
void runTest( int argc, char** argv) 
{
	...
	char *kernelSource;
	size_t kernelLength;
/* the cyclone v runtime needs to runt the code from the binary and cannot compile the source
...
*/
	clProgram = ocdBuildProgramFromFile(context, device_id, "needle_kernel.aocx");
