...
const char* kernelSource1 = "bfs_kernel.aocx";
...
/* //platfrom dependent code does not run on Altera since the altera host does not support
   //compiling on the device host
...
*/
	cl_program kernel1Program = ocdBuildProgramFromFile(context, device_id, kernelSource1);
